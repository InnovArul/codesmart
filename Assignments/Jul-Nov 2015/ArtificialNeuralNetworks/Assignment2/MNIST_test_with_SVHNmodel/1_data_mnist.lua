...
trainData = {
   data = loaded.data,
   -- correct the labels as per SVHN data (in SVHN, all the labels are appropriate except pic 0( pic 0 = label 10)
   -- in MNIST, all the labels are added by 1 & pic 0 = label 1 ( pic 0 = label 1) 
   labels = loaded.labels - 1,
   size = function() return trsize end
}
trainData.labels:apply(function(x) if x==0 then return 10 else return x end end)
